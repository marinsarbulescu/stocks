...
import { createPortfolioStock } from "./graphql/mutations";
const client = generateClient();
export default function PortfolioStockCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPdp(initialValues.pdp);
    setPlr(initialValues.plr);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPortfolioStock.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PortfolioStockCreateForm")}
      {...rest}
    >
      <TextField
        label="Symbol"

...
export default function Home() {
  // // Remove useAuthenticator hook if not needed directly on home page
  // // Remove portfolio state, fetch logic, etc.

  // return (
  //   <main className={styles.main}>
  //     <h1>Home Page</h1>
  //     <p>Welcome to your Stocks Portfolio Dashboard.</p>
  //     <p>Insights will be displayed here.</p>
  //     {/* Add specific home page content here */}
  //   </main>
  // );
}
